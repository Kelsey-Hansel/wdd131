...
const temples = [
    ...
    },
    {
        ...
        area: 71125,
        imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/pocatello-idaho-temple/pocatello-idaho-temple-23276-main.jpg"
    },
    {
...
function createTempleCard(temple, index) {
    ...
    templeSize.textContent = `Size: ${temple.area} sq ft`;
    ...
    cardContainer.appendChild(templeCard);
}

function getDateOld(value) {
    let dateString = value.dedicated.split(",");
...
function getSizeLarge(value) {
    let size = value.area;
    return size > 90000;
}

function getSizeSmall(value) {
    let size = value.area;
    return size < 10000;
}
